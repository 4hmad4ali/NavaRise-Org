...
window.NR_DATA = {
  ...
  programs: [
    //  Completed Webinars
    {
       ...
       type: "classes",
       status: "done",
       shortDesc: "Learn the core foundations of web development using HTML, CSS, Tailwind, and JavaScript.",
       longDesc:
...

    {
      ...
      type: "webinars",
      status: "done",
      shortDesc: "Discover the basics, types, and real-world applications of Artificial Intelligence.",
      longDesc:
    ...
    },
    {
      ...
      type: "webinars",
      status: "done",
      shortDesc: "Lead with confidence and learn practical ways to create meaningful impact.",
      longDesc:
    ...
    },
    {
      ...
      type: "webinars",
      status: "done",
      shortDesc: "Tools to manage stress, build resilience, and strengthen confidence.",
      longDesc:
    ...
    },
    {
      ...
      type: "webinars",
      status: "done",
      shortDesc: "Section-by-section TOEFL strategies, time management, and test-day tips.",
      longDesc:
    ...
    },
    {
      ...
      type: "webinars",
      status: "done",
      shortDesc: "Learn how pressure and challenges can unlock growth and innovation.",
      longDesc:
    ...
    },
    {
      ...
      type: "webinars",
      status: "done",
      shortDesc: "A beginner-friendly start to coding fundamentals and core concepts.",
      longDesc:
    ...
    },
    {
      ...
      type: "webinars",
      status: "done",
      shortDesc: "Learn about UWC, how to apply, and how to write stronger essays.",
      longDesc:
    ...
    },
    {
      ...
      type: "webinars",
      status: "done",
      shortDesc: "An intensive workshop on threats, best practices, and daily cybersecurity tools.",
      longDesc:
    ...
    //  Completed Classes (updated counts + missing classes added)
    {
      ...
      outcomes: ["Core vocabulary", "Everyday conversation", "Beginner grammar"],
      meta: { duration: "4 weeks",level: "A1", format: "Class", students: "20" }
    },
    {
      slug: "english-a2",
      title: "English A2",
      ...
      outcomes: ["Stronger conversation", "Better comprehension", "A2 grammar practice"],
      meta: {duration: "4 weeks", level: "A2", format: "Class", students: "15" }
    },
    {
      slug: "english-b1",
      title: "English B1",
      type: "classes",
      status: "done",
      shortDesc: "Intermediate English to build fluency and practical communication.",
      longDesc:
      ...
      outcomes: ["Improved fluency", "Expanded vocabulary", "Stronger reading & listening"],
      meta: { duration: "6 weeks",level: "B1", format: "Class", students: "30" }
    },
    {
      slug: "english-b2",
      title: "English B2",
      ...
      outcomes: ["More fluent speaking", "Improved writing", "Advanced reading comprehension"],
      meta: { duration: "6 weeks",level: "B2", format: "Class", students: "35" }
    },
    {
      slug: "german-a1",
      title: "German A1",
      type: "classes",
      status: "done",
      shortDesc: "German A1 fundamentals for beginners: vocabulary, grammar, and everyday conversation.",
      longDesc:
      ...
      outcomes: ["German basics & vocabulary", "Beginner grammar", "Everyday speaking practice"],
      meta: {duration: "12 weeks", level: "A1", format: "Class", students: "15" }
    },
    {
      ...
      type: "classes",
      status: "done",
      shortDesc: "Build confident speaking skills and communicate with clarity.",
      longDesc:
      ...
      outcomes: ["More confidence", "Clearer speaking structure", "Practice with feedback"],
      meta: {duration: "4 weeks", level: "General", format: "Class", students: "30" }
    },
    {
      ...
      meta: { duration: "4 weeks",level: "General", format: "In-person / Online", students: "80" }
    },
    {
      slug: "photography",
      ...
      type: "classes",
      status: "done",
      shortDesc: "Basics of photography, composition, and using a camera/mobile.",
      longDesc:
      ...
      outcomes: ["Framing & lighting basics", "Project-based practice", "Stronger artistic perspective"],
      meta: { duration: "4 weeks",level: "Beginner", format: "In-person / Online", students: "50" }
    },
    //  Completed Contests
    {
      ...
      type: "contests",
      status: "done",
      shortDesc: "A creativity-focused contest celebrating artistic expression.",
      longDesc:
      ...
      outcomes: ["Creativity & self-expression", "Confidence-building", "Celebrating participant achievement"],
    ...
    },
    {
      ...
      type: "contests",
      status: "done",
      shortDesc: "A contest to inspire storytelling and strong written expression.",
      longDesc:
      ...
      outcomes: ["Stronger writing practice", "Creative thinking", "Recognition of effort and talent"],
    ...
    },
    {
      ...
      type: "contests",
      status: "done",
      shortDesc: "A contest to highlight photography skills and creative vision.",
      longDesc:
      ...
      outcomes: ["Creative photography practice", "Improved visual storytelling", "Showcasing talent"],
...
team: {
  leadership: [
    ...
    },
    {
      ...
      contribution: "Leads program growth and coordinates instructors and events.",
